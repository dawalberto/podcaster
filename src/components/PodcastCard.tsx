...
export const PodcastCard = ({ podcast }: { podcast: PodcastEntry }) => {
	...
	return (
		<div className='group relative flex cursor-pointer items-center justify-start gap-4 rounded-md border border-neutral-300 p-3 shadow-lg drop-shadow-lg hover:shadow-2xl md:flex-col md:text-center'>
